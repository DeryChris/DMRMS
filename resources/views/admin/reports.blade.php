...
@section('title', 'Reporttts - DMRMS')

@section('content')
<div class="space-y-6">
    <h1 class="font-heading font-bold text-2xl text-gray-800">Reporttts</h1>

    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h3 class="font-heading font-semibold text-lg text-gray-800 mb-4">Reporttt Builder</h3>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div><label class="block text-sm font-medium text-gray-700 mb-1">Cycle</label><select class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm"><option>2026/01</option><option>2025/02</option></select></div>
        ...
        <button class="mt-4 px-6 py-2 bg-gaf-green text-white rounded-lg text-sm font-medium hover:bg-gaf-dark-green transition">Generate Reporttt</button>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h3 class="font-heading font-semibold text-lg text-gray-800 mb-4">Generated Reporttts</h3>
        <div class="space-y-3">
            @for($i = 1; $i <= 5; $i++)
            <div class="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
                <div class="flex items-center space-x-3">
                    ...
                    <div><p class="text-sm font-medium text-gray-800">Regional Reporttt - 2026/01</p><p class="text-xs text-gray-500">Generated June {{ 10 + $i }}, 2026</p></div>
                </div>
