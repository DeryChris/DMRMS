                ...
                <div class="space-y-6">
                    <div class="gradient-border-left pl-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div><p class="text-sm font-medium text-white">Address</p><p class="text-sm text-white/70">Ghana Armed Forces Headquarters, Burma Camp, Accra</p></div>
                        </div>
                    </div>
                    <div class="gradient-border-left pl-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div><p class="text-sm font-medium text-white">Phone</p><p class="text-sm text-white/70">+233 (0) 302 123 456</p></div>
                        </div>
                    </div>
                    <div class="gradient-border-left pl-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div><p class="text-sm font-medium text-white">Email</p><p class="text-sm text-white/70">recruitment@gaf.mil.gh</p></div>
                        </div>
                    </div>
                </div>
            </div>
