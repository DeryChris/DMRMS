<x-guest-layout title="Create Account" subtitle="Register to begin your recruitment journey">
    <form method="POST" action="{{ route('register') }}" style="display:flex;flex-direction:column;gap:16px;">
        ...
        <div>
            <label for="username" style="display:block;font-size:12px;font-weight:700;color:#4a7a65;margin-bottom:6px;text-transform:uppercase;letter-spacing:0.5px;">Username <span style="color:#dc2626;">*</span></label>
